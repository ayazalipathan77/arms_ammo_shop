  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-[1920px] mx-auto relative z-10">
        ...
        {/* Grid */}
        <div className="w-full py-16 px-6 md:px-12 relative overflow-hidden bg-gradient-to-bl from-void via-charcoal to-void border-t border-pearl/10 rounded-sm">
          {/* Gradient Orbs */}
